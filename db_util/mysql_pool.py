...
from constant.mysql_const import POOL_SIZE
from db_util.db_config.mysql_config import db_config
from db_util.python_rf.pool_convertor import FuzzyMySQLConverter
...
def get_pool_conn_implicitly(_db, pool_info=None):
    ...
    if pool_info:
        ...
        conn = mysql.connector.connect(pool_name = _db,pool_size = pool_size,
